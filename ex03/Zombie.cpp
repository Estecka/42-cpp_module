...
/*   Updated: 2021/03/21 18:42:52 by abaur            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Zombie::Announce(){
	...
	switch (rand() % 9)
	{
		...
		case 0:
		case 1:	std::cout << "BRainbrainbrainbrAin"; break;
		case 2:
		case 3:	std::cout << "* Regurgitates in zombie * "; break;
		case 4:	std::cout << "* Coughs in your face *"; break;
		case 5:	std::cout << "The infection is not real !"; break;
		case 6:	std::cout << "Masks are usless !"; break;
		case 7:	std::cout << "I haven't washed my hands in years and I'm perfectly fine."; break;
		case 8:	std::cout << "Let's all gather in this very crowded place."; break;
	}
	std::cout << std::endl;
}
